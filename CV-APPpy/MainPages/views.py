...
def applicationTrackingSystem(request):
    #text = ["this is the resume in text form", "this is the assignment in text form"]
    #cv = CountVectorizer()
    ...
    context = {}
    return render(request, 'app/ATS.html' ,context)
